...
<!-- Mirrored from learnplus.frontendmatter.com/fixed-instructor-account-edit.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Jun 2018 08:17:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Instructor - Edit account - Fixed layout</title>
        ...
        <div class="card">
            ...
            <div class="tab-content card-body">
                <div class="tab-pane active" id="first">
                    <form action="admin_db.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label for="avatar" class="col-sm-3 col-form-label">Profile</label>
                            <div class="col-sm-9">
                                <div class="media">
                ...
                <i class="material-icons md-18 text-muted">mail</i>
                                    ...
                                    <input type="text" class="form-control" placeholder="Email Address" value="" name="email">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <i class="material-icons md-18 text-muted">language</i>
                                    ...
                                    <input type="text" class="form-control" placeholder="www." value="" name="website">
                                </div>
                            </div>
                        </div>
                       <!-- <div class="form-group row">
            ...
            <div class="sidebar sidebar-left sidebar-light bg-white o-hidden">
              ...
              <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">account_box</i> ADMIN
                   ...
                   <!-- <div class="sidebar-heading">Layout</div>
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="instructor-account.html">
              <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dashboard</i> Fluid Layout
            </a>
                        </li>
                        <li class="sidebar-menu-item active">
                            <a class="sidebar-menu-button" href="fixed-instructor-account.html">
